...
/**
 * Die Klasse <code>ShowItemForm</code> ist eine Form die verschiedene Methoden
 * und Widgets zur Anzeige eines <code>Item</code> bietet.
 * 
...
public class ItemForm extends VerticalPanel {
	...
	/**
	 * Bei der Instanziierung der <code>ItemForm</code> werden die ClickHandler den
	...
	/**
	 * Methode um die aktuelle <code>ItemForm</code> Instanz zu setzen. Diese
	 * Instanz wird für das Aktualisieren nach dem Anlegen eines Items benötigt.
	 * 
	 ...
	 * Diese Instanz wird für das Aktualisieren nach dem Anlegen eines Items
	 * benötigt.
	 * 
	 * @param newShowItemForm das zu setzende <code>newShowItemForm</code> Objekt.
	 */
	 ...
	 * 
	 * @param editable Mithilfe des Wertes wird entschieden ob die
	 *                 <code>ItemForm</code> sich im Edit-Modus befindet oder nicht.
	 */
	...
	/**
	 * Methode um ausgewählte Gruppe zu setzen innerhalb der
	 * <code>AllItemsCellList</code>.
	 * 
	...
	/**
	 * Methode zum Anzeigen des ausgewählten <code>Item</code> Objekts und setzen
	 * des Favourite Icons.
	 * 
	...
	/**
	 * Methode um die <code>ItemForm</code> in den EditModus zu setzen oder den
	...
	/**
	 * FavClickHandler der ein <code>Item</code> als favorisiert markiert. Dabei
	 * wird der Favourite Button gefärbt und die Favourite Markierung des
	 * ausgewählten <code>Item</code> Objekts gesetzt.
	 */
	...
	/**
	 * EditClickHandler der das Bearbeiten des Items ermöglicht. Durch diesen werden
	 * alle Textboxen aktiviert, sowie ein zusätzliches ButtonPanel angezeigt.
	 */
	...
	/**
	 * Sobald der Änderungsvorgang bestätigt wird durch einen Klick auf den
	 * Bestätigungsbutton, wird das <code>Item</code> aktualisiert.
	 */
	...
	/**
	 * Nachdem ein neues <code>Item</code> Objekt erstellt wurde, wird dieses der
	 * Liste der aktuellen <code>AllItemsCelllist</code> Instanz hinzugefügt.
	 */
	...
	/**
	 * Nachdem ein <code>Item</code> Objekt aktualisiert wurde, wird dieses der
	 * Liste der aktuellen <code>AllItemsCelllist</code> Instanz hinzugefügt.
	 */
	...
	/**
	 * Callback mit dem das ausgewählte <code>Item</code> Objekt als Favorit
	 * markiert wird.
	 */
	...
	/**
	 * ClickHandler mit dem überprüft wird, ob sich das ausgewählte
	 * <code>Item</code> in einer <code>ShoppingList</code> als
	 * <code>ListItem</code> befindet.
	 */
	...
	/**
	 * Callback mit dem das ausgewählte <code>Item</code> Objekt nicht mehr als
	 * Favorit markiert wird.
	 */
