...
public class NavigatorPanel extends TabPanel {
	...
	/**
	 * In dieser Methode wird das Design des <code>NavigatorPanels</code> und der Widgets
	 * festgelegt. Diese Methode wird aufgerufen, sobald ein Objekt dieser Klasse
	 * instanziert wird.
	 */
	public void onLoad() {
