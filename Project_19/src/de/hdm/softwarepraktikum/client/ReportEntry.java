...
public class ReportEntry implements EntryPoint {
	...
	/**
	 * Bei erfolgreichem RPC callback wird zu Beginn die <code>CurrentPerson<code>
	 * gesetzt. Anschließend erfolt eine Abfrage ob die Person bereits im System
	 * eingeloggt ist Falls dies zutrifft, wird die Shoppinglistadministration Maske
	 * aufgerufen Falls die nicht zutrifft, wird die <code>loadLogin()<code>
	 * aufgerufen, indem sich die Person am System anmelden kann
	 */
	...
	/**
	 * Durch einen Klick auf den loginButton wird der User auf die Google LoginMaske
	 * weitergeleitet
	 */
	...
	/**
	 * Die Klasse <code>CurrentPerson</code> repräsentiert den aktuell am System
	 * angemeldeten User. Da weitere GUI-Klassen das angemeldetet Person-Objekt
